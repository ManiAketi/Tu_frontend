...
const VideoPlayer = {
        ...
        newVideoEl.addEventListener('error', (e) => {
            ...
            if (newVideoEl.error) {
                switch(newVideoEl.error.code) {
                    ...
                    case 3: errorMsg += ' (Decode error - codec issue)'; break;
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="video-player-container mb-3" style="min-height: 400px;">
                                <video id="videoPlayer" controls width="100%" style="background:#000; min-height: 400px; width: 100%;">
    ...
    buildVideoUrl(camera, timestamp) {
      ...
      return `${CA.VIDEO_BASE}/api/video/stream?${params}`;
  },
